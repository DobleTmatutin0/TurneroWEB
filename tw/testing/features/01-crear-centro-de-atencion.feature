...
Antecedentes: Dado que existe un sistema de gestión de centros de atención
...
#     1. El Centro de Atención debe tener nombre, dirección (calle, altura, localidad, provincia y coordenadas geográficas).        
#     2. Si el Centro de Atención ya existe (nombre y dirección coinciden), se debe rechazar la creación.